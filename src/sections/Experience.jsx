...
function Experience() {
  ...
  return (
    <section id="experience" className="section-padding relative overflow-hidden bg-[#020617]/50">
      <div className="container-custom flex flex-col items-center">
                  ...
                  <div className="flex flex-col sm:flex-row items-start gap-4 md:gap-8">
                    ...
                    <div className="space-y-2 md:space-y-3">
                      <div className="flex flex-wrap items-center gap-3">
                        ...
                        {exp.current && (
                          <span className="px-3 py-1 rounded-full bg-emerald-500/10 text-emerald-400 text-[9px] md:text-[10px] font-black uppercase tracking-widest border border-emerald-500/20 shadow-lg">
                            Present
                          </span>
                        )}
                      </div>
        ...
        {experiences.length === 0 && (
          <div className="text-center py-12 md:py-20 glass-card-vibrant rounded-3xl w-full max-w-3xl">
            <p className="text-gray-500 font-black uppercase tracking-widest text-sm">Experience history is currently empty</p>
          </div>
        )}
      </div>
    </section>
