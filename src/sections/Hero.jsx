...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-[#020617]">
      ...
      {/* Main Content */}
      <div className="relative z-10 w-full container-custom flex flex-col items-center text-center pt-56 sm:pt-64 md:pt-80 pb-16 sm:pb-20 md:pb-24 gap-6 sm:gap-8 md:gap-10 px-4">
