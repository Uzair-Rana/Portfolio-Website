...
import resumePdf from '../assets/Uzair_Anjum_DevOOP_Engineer.pdf';
  ...
  return (
    <section className="relative w-screen h-screen overflow-hidden bg-black text-[#E8DFD8] font-sans selection:bg-[#cbb59d] selection:text-black cursor-none">
      ...
      <div className="fixed inset-0 z-0 overflow-hidden pointer-events-none bg-black flex items-center justify-end">
        ...
        >
          <source src="/videos/Background%20video.mp4" type="video/mp4" />
        </video>
          ...
          >
            ...
            <motion.div variants={fadeUpVariants} className="mb-4">
              <p
                ...
                style={{ fontFamily: "'Montserrat', sans-serif" }}
              >
                AI FULL-STACK ENGINEER <span className="text-[#8C6D4F] mx-1">•</span> LLM INTEGRATION <span className="text-[#8C6D4F] mx-1">•</span> CLOUD
              </p>
            </motion.div>
            ...
            >
              <p>
                I build custom web apps, RESTful APIs and AI-powered features.
                <br />
                Django and React under the hood, deployed at scale on AWS.
              </p>
            </motion.div>
            ...
            >
              ...
              <motion.a
                href={resumePdf}
                download="Uzair_Anjum_DevOps_Engineer.pdf"
                target="_blank"
