...
const bentoCategories = [
  {
    ...
    badge: 'CORE PILLAR',
    items: ['Python', 'Django', 'Django REST Framework', 'Node.js', 'Celery', 'GraphQL', 'WebSockets'],
    description: 'RESTful and GraphQL APIs, background task pipelines, email automation and real-time features for production SaaS platforms.',
    stat: 'REST · GRAPHQL',
  ...
  },
  {
    title: 'FRONTEND',
    badge: 'INTERFACES',
    items: ['React', 'Vue.js', 'TypeScript', 'JavaScript', 'Tailwind CSS', 'HTML', 'CSS'],
    description: 'Responsive, component-driven client apps in React and Vue.js, built from client requirements and Figma designs.',
    stat: 'REACT · VUE',
  ...
  },
  {
    ...
    items: ['AWS EC2', 'S3', 'Lambda', 'Route 53', 'CloudFront', 'ACM', 'GCP', 'Azure', 'Docker', 'CI/CD'],
    description: 'Containerized deployments on AWS with CDN delivery, DNS and SSL management, and automated CI/CD pipelines.',
    stat: 'AWS · GCP · AZURE',
    colSpan: 'lg:col-span-5',
  },
  {
    title: 'AI, LLMS & DATA',
    badge: 'INTELLIGENCE',
    items: ['LLM Integration', 'Prompt Engineering', 'OpenAI', 'LangGraph', 'MCP', 'PostgreSQL', 'MySQL', 'Redis', 'Firebase'],
    description: 'Integrating LLMs, AI voice and agent workflows into real products, backed by tuned PostgreSQL and MySQL databases and Redis caching.',
    stat: 'LLM INTEGRATION',
    colSpan: 'lg:col-span-7',
  },
];
