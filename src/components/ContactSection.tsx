...
const EMAIL = 'uzairanjummrana@gmail.com';
const PHONE = '+92 310 7575202';

// Only shown when a URL is filled in.
const socialLinks = [
  { label: 'LINKEDIN', href: '' },
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between">
            <div>
              ...
              <p
                ...
                style={{ fontFamily: "'Montserrat', sans-serif" }}
              >
                Have a web app to build, an AI feature to integrate, or an engineering role to fill? Send a message or reach me directly.
              </p>
              ...
              <div className="mt-10 space-y-3 max-w-md">
                {contactDetails.map((item) => (
                  ...
                  >
                    <span className="text-[10px] font-mono tracking-[0.2em] text-[#8C6D4F]">
                      {item.label}
                    </span>
                    {item.href ? (
                      <a
                        href={item.href}
                        className="text-[11px] font-mono font-medium text-[#F7E7C4] hover:text-[#D4AF37] transition-colors break-all text-right"
                      >
                        {item.value}
                      </a>
                    ) : (
                ...
                <div className="mt-6 flex flex-wrap gap-3">
                  {socialLinks.map((link) => (
                    <a
                      ...
                      className="group inline-flex items-center space-x-2 py-2 px-4 border border-[#8C6D4F]/50 hover:border-[#D4AF37] text-[#EAD8C7] text-[11px] tracking-[0.24em] font-light uppercase transition-all duration-300"
                      style={{ fontFamily: "'Montserrat', sans-serif" }}
                    >
            ...
            {sent ? (
              <div className="py-16 text-center space-y-4">
                ...
                <p className="text-xs text-[#A8988B] font-light" style={{ fontFamily: "'Montserrat', sans-serif" }}>
                  ...
                  <br />
                  If it didn't open, email me at{' '}
                  <a href={`mailto:${EMAIL}`} className="text-[#F7E7C4] hover:text-[#D4AF37] transition-colors">
                    {EMAIL}
                  </a>
                  .
                </p>
        ...
        <div className="pt-16 mt-16 border-t border-[#8C6D4F]/15 flex flex-col sm:flex-row items-center justify-between text-center sm:text-left gap-4">
          ...
          <span className="text-[10px] font-mono text-[#8C6D4F]">
            © {new Date().getFullYear()} • MUHAMMAD UZAIR ANJUM
          </span>
        </div>
