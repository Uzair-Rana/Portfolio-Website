...
const journey: RouteStop[] = [
  {
    ...
    organization: 'DEVNEST SYSTEMS, BHAKKAR · HYBRID',
    description: 'Leading the development team and building full-stack products with Django and React.js, from requirements through to delivery.',
    highlights: [
      'Lead the development team: planning work, reviewing code and guiding developers',
      'Built a full-stack inventory management and e-commerce platform with an admin dashboard and sales reporting',
      'Delivered the SDSSS security and surveillance website on a Django REST API with a Vue 3 frontend',
      'Designed REST APIs, secure authentication and efficient database models for scalable systems',
    ],
  },
  {
    id: '02',
    ...
    organization: 'SYSTEMSD, LAHORE',
    description: 'Built full-stack applications with Django, React and Vue.js based on client requirements, then deployed and managed them on AWS.',
    highlights: [
      'Deployed containerized apps with Docker on AWS (EC2, S3, Lambda, CloudFront)',
      'Optimized database performance across PostgreSQL and MySQL',
      'Implemented Redis caching and email automation for faster, smoother user experiences',
      'Shipped features faster with AI-assisted tools: Claude, ChatGPT and Cursor',
      'Mentored junior developers on best practices, RESTful API design and cloud deployment',
      'Delivered on schedule with cross-functional teams using JIRA, Slack and Git workflows',
    ],
  },
  {
    id: '03',
    ...
    description: 'Graduated with a CGPA of 3.57, building a strong foundation in software engineering, databases and web development.',
  },
];
                  ...
                  {stop.highlights && (
                    ...
                    >
                      {stop.highlights.map((item) => (
                        <li
                          key={item}
                          className="flex items-start gap-3 text-xs sm:text-[13px] font-light text-[#A8988B] leading-[1.7] group-hover:text-[#D5CBC0] transition-colors"
                        >
                          <span className="mt-[0.6em] w-2 h-px shrink-0 bg-[#D4AF37]/60" />
                          <span>{item}</span>
                        </li>
                      ))}
                    </ul>
